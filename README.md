...
You may use, modify, and redistribute this software under the terms of the GPL. See the [license text](LICENSE) and https://www.gnu.org/licenses/gpl-3.0.html for full terms.
